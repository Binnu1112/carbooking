                        ...
                        <form runat="server">
                           ...
                           <div class="row">
                            ...
                            <asp:TextBox CssClass="form-control" ID="password" runat="server" placeholder="Password"></asp:TextBox><br /><br />
                                       ...
                                       <div class="col-4">
                                             <asp:Label ID="Label7" runat="server" Text="Confirm password" Font-Bold="True" Font-Size="Large" ForeColor="Black"></asp:Label>
                            ...
                            <asp:Button CssClass="btn btn btn-success" Width="100" ID="registerbtn" runat="server" Text="Register" />
